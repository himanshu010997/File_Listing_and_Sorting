...
public class SortFiles {
   ...
   public static void main(String[] args) throws IOException {
       ...
       String dirPath = "E:\\Matter\\Programming\\Sort_And_List_Files\\src";
       ...
       if(dir.exists() && dir.isDirectory()) {
           ...
           if(sizeList==0) {
	           ...
	           for(i=sizeList-1; i>-1; i--) {
	        	   System.out.println("\t"+Biggest10[i].getName()+" :  "+Biggest10[i].length()/1000000+" MB");
	           }
           }
       }
       ...
       System.out.println("Please enter user name of the PC");
       Scanner read = new Scanner(System.in);
       String user = read.nextLine();
       
       String desktopPath = "C:\\Users\\"+user+"\\Desktop";// "+user+"
       String documentsPath = "C:\\Users\\"+user+"\\Documents";
				...
				for(i=0; i<sizefiles; i++) {
			        ...
			        if(files[i].isFile()) {
			        	...
			        	if(extension.equals("lnk") || extension.equals("url") || extension.equals("exe"))
				        	...
				        	File fileExtnDir = new File(documentsPath+"\\"+extension);
